...
namespace af {
    ...
    private:
        ...
        int stackingOffset;
        bool mounted, isVisibleNextFrame, isVisible, rectModified, 
            shouldTriggerParentResize, clipping, debug;
        glm::vec2 pivot, offset;
        Rect relativeRect, screenRect, defaultScreenRect;
